...
import { KanbanColumn } from '@/hooks/projects/kanban/kanbanInterfaces';

interface DeleteKanbanColumnDialogProps {
...
export const DeleteKanbanColumnDialog = ({
  trigger,
  onDeleteColumn,
  column,
  isSubmitting,
}: DeleteKanbanColumnDialogProps) => {
  ...
  const confirmDelete = () => {
    ...
    toast.warning(`Deleting ${column.columnName}`, {
      description: (
        <div>
          <p>This column will be deleted in a few seconds</p>
      ...
      action: {
        ...
        onClick: () => {
          ...
          if (deleteTimeoutRef.current) {
            clearTimeout(deleteTimeoutRef.current);
            deleteTimeoutRef.current = null;
            toast.info(`Deletion of ${column.columnName} canceled`);
          }
        },
      },
    });
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent className="max-w-md shadow-lg">
        <AlertDialogHeader>
            ...
            <div className="flex items-center gap-2">
              <div className="flex flex-col">
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span>All tasks in this column will be permanently removed</span>
                </div>
                <div className="flex items-center gap-2 mt-1">
                  <span className="text-destructive">•</span>
          ...
          <AlertDialogDescription className="sr-only">Delete column confirmation dialog</AlertDialogDescription>
        </AlertDialogHeader>
