...
export const ProjectGrid = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <ProjectCard project={mockProjects[4]} />
      <ProjectCard project={mockProjects[5]} />
    </div>
  );
};