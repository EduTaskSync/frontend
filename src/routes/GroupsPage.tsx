...
import { GroupData } from '@/components/groups/GroupDetailsDialog';
...
const GroupsPage = () => {
  ...
  const handleGroupCreation = (formattedData: GroupData) => {
      ...
      {isDetailsPage ? (
        ...
        <MainContent>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <GroupDetailsDialog onSubmit={handleGroupCreation} isUpdating={createGroupResponse.isPending} />
          </div>
          <GroupGrid />
        </MainContent>
      )}
